...
/**
 * FamilyTree - A simple Family Tree Generator
 *
 * The FamilyTree class is a parent-children hierarchy tree generator that facilitates the creation and management
 * of genealogy structures. It provides a flexible and dynamic way to create organized data, add unlimited children,
 * change parent relationships, and update object attributes.
 *
 * ### Example
 * ```php
 ...
 * $mother = $familyTree->add('mother', [
 *     'name' => 'Angel',
 *     'profile' => '//example.com/mother'
 * ]);
 *
 * // Add child
 * $honestChild = $mother->add('child-1', [
 *     'name' => 'Gabriel',
 *     'ability' => function() {
 *          // ...
 *      }
 ...
 *
 * // Add another child
 * $naughtyChild = $mother->add('child-2', [
 *     'name' => 'Plankton',
 *     'school' => 'Coconut Head Comprehensive College'
 * ]);
 * ```
 *
 * ***
 *
 * > To utilize the FamilyTree instance effectively, you need to create a recursive function that can parse the nodes in the familyTree object and generate the desired tree structure.
 ...
 * ***
 *
 * FamilyTree is a versatile class that provides functionality for creating and managing hierarchical structures,
 * primarily designed for menus. However, it can also be used for various other purposes involving hierarchical data.
 *
 * Here are a few examples of how the FamilyTree class can be utilized beyond menu creation:
 *
 * 1. **Nested Lists:** FamilyTree can be used to generate nested lists, such as hierarchical directory structures,
 *    table of contents, or any other nested list-based data representation.
 *
 * 2. **Site Maps:** FamilyTree can assist in creating site maps for websites, allowing you to generate a hierarchical
 ...
 *    hierarchy. FamilyTree can help generate breadcrumbs by representing the hierarchical structure and rendering
 ...
 *    category trees, or file systems, FamilyTree can be used to create and manage the tree view.
 *
 * 5. **Dynamic Navigation:** FamilyTree enables you to dynamically manage and update navigation menus on your website
 ...
 *
 * 6. **Content Organization:** FamilyTree can be used to organize and manage content in a hierarchical manner. This can be
 *    helpful for creating and managing complex content structures, such as multi-level categories, tags, or sections.
 *
 * These are just a few examples of how the FamilyTree class can be utilized beyond menu creation. Its flexibility and
 ...
 * @version    2.0.6
 * @author     Your Name
 * @link       https://github.com/ucscode/familyTree
 */
class FamilyTree
{
    /**
     * The name of the FamilyTree object
     *
     * @var string
     */
    protected $name;
    ...
    /**
     * The parent of the FamilyTree object
     *
    ...
    /**
     * The depth or level of the FamilyTree object
     *
     * @var null|int
     */
    ...
    /**
     * The children of the FamilyTree object
     *
     * An array containing multiple FamilyTree objects representing the FamilyTree children
     *
     * @var array
     */
    protected $child = [];
    ...
    /**
     * The attributes of the FamilyTree object
     *
     * The storage box of FamilyTree object
     *
     * @var array
     */
    protected $attrs = [];
     ...
     *
     * Creates a new instance of the FamilyTree class.
     *
     ...
     * Add Child Node
     *
     * Adds a child node to the current FamilyTree object.
     *
     * @param string $name The name of the child node.
     * @param array $attrs The attributes of the child node, specified as an associative array.
     * @return self The newly created child FamilyTree object.
     * @throws \Exception If a child node with the same name already exists in the current FamilyTree object.
     */
     ...
     * Get Child Node
     *
     * Retrieves a child node from the current FamilyTree object based on its name.
     *
     * @param string $name The name of the child node to retrieve.
     * @return self|null The child FamilyTree object if found, or `null` if not found.
     */
     ...
     * Remove Child Node
     *
     * Removes a child node from the current FamilyTree object based on its name.
     *
     * @param string $name The name of the child node to remove.
     * @return self The updated FamilyTree object after the child node has been removed.
     */
     ...
     * Set Attribute
     *
     * Sets an attribute for the current FamilyTree object.
     *
     ...
     * Get Attribute
     *
     * Retrieves the value of a specified attribute from the current FamilyTree object.
     *
     ...
     * Remove Attribute
     *
     * Removes a specified attribute from the current FamilyTree object.
     *
    ...
    public function __debuginfo() {
        ...
        global $FamilyTreeClassDebugLevel;

        if( is_null($FamilyTreeClassDebugLevel) ) $FamilyTreeClassDebugLevel = -1;

        $FamilyTreeClassDebugLevel++;

        $data = array();

        //if( $FamilyTreeClassDebugLevel ) return $data;
